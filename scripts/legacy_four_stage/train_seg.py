"""ARCHIVED: backward-compatible training shim (archived 2026-09-21).
...
Legacy mapping:
    --stage a  -> legacy_four_stage/train_models.py --stage a
    --stage b  -> legacy_four_stage/train_models.py --stage b-polar

Legacy args --data and --weights are still accepted (--weights is ignored
because all stages initialize from the configured base checkpoint).
"""
