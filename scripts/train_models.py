"""RETIRED entry: the four-stage training CLI was archived 2026-09-21.
...
The archived implementation lives in:
    scripts/legacy_four_stage/train_models.py
...
MESSAGE = (
    "scripts/train_models.py is retired (four-stage training archived "
    "2026-09-21).\n"
