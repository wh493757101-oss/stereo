"""RETIRED entry: the legacy training shim was archived 2026-09-21.
...
The archived implementation lives in:
    scripts/legacy_four_stage/train_seg.py
...
MESSAGE = (
    "scripts/train_seg.py is retired (four-stage training archived "
    "2026-09-21).\n"
